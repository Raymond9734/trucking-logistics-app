...
router.register(r'duty-status-records', DutyStatusRecordViewSet, basename='duty-status-records')
...
urlpatterns = [
    ...
    path('log-sheets/<uuid:pk>/grid-data/', 
