/**
 * Design System Constants for Trucking Logistics App
 * 
 * This file contains all design tokens, constants, and configuration
 * values used throughout the application for consistency.
 */
...
// Trucking-specific constants
export const TRUCKING = {
  compliance: {
    colors: {
      violation: COLORS.error[500],
      warning: COLORS.warning[500],
      compliant: COLORS.success[500],
...
// Status and state colors for different UI elements
